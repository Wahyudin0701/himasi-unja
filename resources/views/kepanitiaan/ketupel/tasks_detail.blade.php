...
@section('content')
    ...
    <div class="flex items-center justify-end mb-8">
        <a href="{{ route('kepanitiaan.ketupel.progres.divisi', ['event' => $task->event_id]) }}" class="text-sm font-bold text-slate-500 hover:text-slate-900 transition-colors flex items-center gap-1.5">

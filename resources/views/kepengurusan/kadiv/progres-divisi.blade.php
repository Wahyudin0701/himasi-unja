                            ...
                            <div class="border border-slate-200 rounded-2xl overflow-hidden bg-white transition-all duration-200"
                                ...
                                <div x-show="openMember === {{ $member->id }}" x-collapse>
                                    <div class="border-t border-slate-100">
                                        ...
                                        @else
                                            @php
                                                $colTodo     = $tasks->where('status', 'todo');
                                                $colWaiting  = $tasks->where('status', 'waiting');
                                                $colRevisi   = $tasks->whereIn('status', ['revisi', 'revision']);
                                                $colDone     = $tasks->where('status', 'completed');
                                            @endphp
                                                    ...
                                                    <div class="p-4">
                                                        ...
                                                        <div class="space-y-2">
                                                            @forelse($colTodo as $task)
                                                                ...
                                                                <a href="#" class="block bg-white border {{ $isOverdue ? 'border-rose-200' : 'border-slate-200' }} rounded-xl p-3 shadow-sm hover:shadow-md hover:border-brand-200 transition-all duration-200 group">
                                                    ...
                                                    <div class="p-4 bg-blue-50/30">
                                                        ...
                                                        <div class="space-y-2">
                                                            @forelse($colWaiting as $task)
                                                                <a href="#" class="block bg-white border border-slate-200 rounded-xl p-3 shadow-sm hover:border-brand-300 hover:shadow-md transition-all duration-200 group">
                                                                    <div class="flex items-start justify-between gap-2 mb-2">
                                                                        @if($task->priority == 'high')
                                                                            <span class="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-bold bg-rose-100 text-rose-600 shrink-0">HIGH</span>
                                                                        @elseif($task->priority == 'medium')
                                                    ...
                                                    <div class="p-4 bg-amber-50/30">
                                                        ...
                                                        <div class="space-y-2">
                                                            @forelse($colRevisi as $task)
                                                                <a href="#" class="block bg-white border border-amber-200 rounded-xl p-3 shadow-sm hover:border-amber-400 hover:shadow-md transition-all duration-200 group">
                                                                    <div class="flex items-start justify-between gap-2 mb-2">
                                                                        @if($task->priority == 'high')
                                                                            <span class="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-bold bg-rose-100 text-rose-600 shrink-0">HIGH</span>
                                                                        @elseif($task->priority == 'medium')
                                                    ...
                                                    <div class="p-4 bg-emerald-50/30">
                                                        ...
                                                        <div class="space-y-2">
                                                            @forelse($colDone as $task)
                                                                <a href="#" class="block bg-white border border-emerald-200 rounded-xl p-3 shadow-sm opacity-80 hover:opacity-100 hover:shadow-md transition-all duration-200 group">
                                                                    <div class="flex items-start justify-between gap-2 mb-2">
                                                                        @if($task->priority == 'high')
                                                                            <span class="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-bold bg-rose-100 text-rose-600 shrink-0">HIGH</span>
                                                                        @elseif($task->priority == 'medium')
